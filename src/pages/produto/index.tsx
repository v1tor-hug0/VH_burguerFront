            ...
            <article className={styles.produto}>
                <div className={styles.container_produto}>
                    ...
                    <div className={styles.inputs}>
                        ...
                        <input type="text" name="nome" placeholder="BBQ Especial" value={nome} onChange={(e) => setNome(e.target.value)} />
                    </div>
                    ...
                    <div className={styles.inputs}>
                        ...
                        <input type="number" name="preco" placeholder="40,00" value={preco} onChange={(e) => setPreco(e.target.value)}/>
                    </div>
                    <div className={styles.inputs}>
                        <label htmlFor="cat">Categoria</label>
                        <select name="cat" multiple onChange={(e) => setCategoriasSelecionadas(
